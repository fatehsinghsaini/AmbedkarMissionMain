...
class DistrictAdapter(internal var mContext: Context?, private val stateList: List<String>) : RecyclerView.Adapter<DistrictAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (country != null) {
            holder.txtCountryName.text = country
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
       ...
       // var txtCountryCode: TextView
        ...
        override fun onClick(v: View) {
            when (v.id) {
                R.id.llCountryRow -> countrySelectListener.onDistrictClick(adapterPosition)
            }
        }
    }
}